      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="rounded-xl bg-blue-600 p-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col items-center">
              <img
                src="/public/icones/html_icone.png"
                alt="HTML Icon"
                className="w-10 md:w-12 lg:w-14 mb-2"
              />
              <p className="mb-4">HTML</p>
              <img
                src="/public/icones/css_icone.png"
                alt="CSS Icon"
                className="w-10 md:w-12 lg:w-14 mb-2"
              />
              <p className="mb-4">CSS</p>
              <img
                src="/public/icones/javascipt_icone.png"
                alt="JavaScript Icon"
                className="w-10 md:w-12 lg:w-14 mb-2"
              />
            ...
            <div className="flex flex-col items-center">
              <img
                src="/public/icones/bootstrap_icone.png"
                alt="Bootstrap Icon"
                className="w-10 md:w-12 lg:w-14 mb-2"
              />
              <p className="mb-4">Bootstrap</p>
              <img
                src="/public/icones/tailwind_icone.png"
                alt="Tailwind Icon"
                className="w-10 md:w-12 lg:w-14 mb-2"
              />
              <p className="mb-4">Tailwind</p>
              <img
                src="/public/icones/react_icone - .png"
                alt="React Icon"
                className="w-10 md:w-12 lg:w-14 mb-2"
              />
        ...
        <div className="rounded-xl bg-blue-600 p-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col items-center">
              <img
                src="/public/icones/php_icone.png"
                alt="PHP Icon"
                className="w-10 md:w-12 lg:w-14 mb-2"
              />
            ...
            <div className="flex flex-col items-center">
              <img
                src="/public/icones/sql_icone.png"
                alt="SQL Icon"
                className="w-10 md:w-12 lg:w-14 mb-2"
              />
        ...
        <div className="rounded-xl bg-blue-600 p-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col items-center">
              <img
                src="/public/icones/shopify_icone.png"
                alt="Shopify Icon"
                className="w-10 md:w-12 lg:w-14 mb-2"
              />
              <p className="mb-4">Shopify</p>
              <img
                src="/public/icones/wordpress_icone.png"
                alt="WordPress Icon"
                className="w-10 md:w-12 lg:w-14 mb-2"
              />
            ...
            <div className="flex flex-col items-center">
              <img
                src="/public/icones/figma_icone.png"
                alt="Figma Icon"
                className="w-10 md:w-12 lg:w-14 mb-2"
              />
